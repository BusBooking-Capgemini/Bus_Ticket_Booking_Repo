...
using Route = API_Bus_Ticket_Booking.Models.Route;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ARSH-DHILLON\\SQLEXPRESS;Initial Catalog=busticketbooking;Integrated Security=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__addresse__CAA247C8344D5E3B");
        ...
        {
            entity.HasKey(e => e.AgencyId).HasName("PK__agencies__7224EBF804E8C23C");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Agencies)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK_agencies_roles");
        });

        modelBuilder.Entity<AgencyOffice>(entity =>
        {
            entity.HasKey(e => e.OfficeId).HasName("PK__agency_o__2A196375AD254390");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.AgencyOffices)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK_agency_offices_roles");
        });

        modelBuilder.Entity<Booking>(entity =>
        {
            entity.HasKey(e => e.BookingId).HasName("PK__bookings__5DE3A5B1818F53C4");
        ...
        {
            entity.HasKey(e => e.BusId).HasName("PK__buses__6ACEF8EDE9B5CE14");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8570BD74C0");
        ...
        {
            entity.HasKey(e => e.DriverId).HasName("PK__drivers__A411C5BDEEE9C3C2");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payments__ED1FC9EA8B95EB86");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__reviews__60883D90E80FDAF4");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__roles__760965CC10D7CC82");

            entity.ToTable("roles");

            entity.HasIndex(e => e.RoleName, "UQ__roles__783254B1BF0B4D24").IsUnique();
        ...
        {
            entity.HasKey(e => e.RouteId).HasName("PK__routes__28F706FEE5814821");
        ...
        {
            entity.HasKey(e => e.TripId).HasName("PK__trips__302A5D9E8FBFE1E7");
