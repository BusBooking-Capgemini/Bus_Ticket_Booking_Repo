...
public class TripRepository : ITripRepository
{
    ...
    public async Task<List<Trip>> SearchTripsAsync(
        string? fromCity,
        string? toCity,
        DateTime? date,
        int? minSeats,
    ...
    )
    {
        ...
        var query = _context.Trips.Include(t => t.Route).Include(t => t.Bus).AsQueryable();
    ...
    public async Task<List<Trip>> GetUpcomingTripsAsync()
    {
        ...
        return await _context
            .Trips.Where(t => t.TripDate >= DateTime.UtcNow.Date)
            .Include(t => t.Route)
            .Include(t => t.Bus)
    ...
    public async Task<List<Trip>> GetTripsByRouteAsync(int routeId)
    {
        ...
        return await _context
            .Trips.Where(t => t.RouteId == routeId && t.TripDate >= DateTime.UtcNow.Date)
            .Include(t => t.Route)
            .Include(t => t.Bus)
            .OrderBy(t => t.TripDate)
            .ToListAsync();
