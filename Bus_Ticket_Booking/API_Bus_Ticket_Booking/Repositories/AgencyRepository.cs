...
namespace API_Bus_Ticket_Booking.Repositories
{
    public class AgencyRepository : IAgencyRepository
    {
        ...
        public async Task<IEnumerable<Agency>>
            GetAllAsync()
        {
        ...
        public async Task<IEnumerable<AgencyOffice>>
        ...
        public async Task<IEnumerable<Bus>>
            GetOfficeBusesAsync(
                int agencyId,
                int officeId)
        {
        ...
        public async Task<IEnumerable<Driver>>
