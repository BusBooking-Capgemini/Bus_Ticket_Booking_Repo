...
namespace API_Bus_Ticket_Booking.Repositories.Interfaces
{
    public interface IBookingRepository
    {
        ...
        // Agency Bookings
        Task<IEnumerable<Booking>> GetAgencyBookingsAsync(int agencyId);
        ...
        // Check if a customer has booked a specific trip (used for review validation)
        Task<bool> CustomerHasBookedTripAsync(int customerId, int tripId);

        // Dashboard - Office
        Task<int> GetTotalBookingsByOfficeAsync(int officeId);
        ...
        Task<double> GetOccupancyRateByAgencyAsync(int agencyId);
        Task<int> GetMostBookedTripByOfficeAsync(int officeId);
        Task<int> GetMostBookedTripByAgencyAsync(int agencyId);
        Task<string> GetMostPopularRouteByOfficeAsync(int officeId);
        Task<string> GetMostPopularRouteByAgencyAsync(int agencyId);
